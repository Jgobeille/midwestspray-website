...
const Footer = ({ companyName }) => (
  <footer className="w-full px-4 py-6 shadow-sm bg-celadon-blue-default">
    <div className="container  mb-14 pl-20 pr-20 grid grid-cols-4 gap-x-6 ">
      <div className="flex flex-col">
        <h3 className="font-main mb-4 text-white text-lg">Midwest Spray</h3>
        <p className="font-secondary mb-4 text-white text-xs">
          I'm baby drinking vinegar cray church-key shaman pabst cronut hexagon
          banjo af snackwave cliche leggings
        </p>
      ...
      <div className="flex flex-col">
        ...
        <a
          ...
          href="https://goo.gl/maps/mAa36uwWA6QyZ2ABA"
        >
          {' '}
        ...
        <a
          className="no-underline mb-1 font-secondary text-white text-xs"
          href="tel:+1-513-476-8408"
        >
          513-476-8408
        </a>
        <a
          className="no-underline mb-1 font-secondary text-white text-xs"
          href="mailto: dgobeille@cinci.rr.com"
        >
